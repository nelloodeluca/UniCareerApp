        ...
        <ModalCard>
          ...
          <ScrollContainer>
            <ModalContent>
              ...
              <StyledParagraph>
                <BoldText>Ora:</BoldText>{' '}
                {esame.ora != null ? esame.ora : 'Info Non Disponibile'}
              </StyledParagraph>
              <StyledParagraph>
                <BoldText>Luogo:</BoldText>{' '}
                {esame.luogo != '' ? esame.luogo : 'Info Non Disponibile'}
              </StyledParagraph>
              <StyledParagraph>
                <BoldText>Tipologia:</BoldText> {esame.tipologia}
              </StyledParagraph>
              <StyledParagraph>
                <BoldText>Docente:</BoldText>{' '}
                {esame.docente != '' ? esame.docente : 'Info Non Disponibile'}
              </StyledParagraph>
              {esame.voto !== null ? (
                <StyledParagraph>
