...
export const ExamsProvider: ({ children }: { children: any }) => void = ({ children }) => {
  ...
  const updateCategory = (updatedCategory: Categoria) => {
    ...
    const insertOrReplaceExam = async (esame: any) => {
      try {
    ...
    return (
      <ExamsContext.Provider
        value={{
          ...
          addCategory,
          updateCategory,
          insertOrReplaceExam, // Add the new function to context
          getMaxGrade,
          getMinGrade,
          getArithmeticMean,
          getWeightedMean,
